...
% (...
% t1,t2,tOrder,fourthOrderT,beta,g,mu,tref,u,v,x,y,Nxg,Nyg,...
%     mubx,muby,hx,hy,fx,fy,...
%     UN,UC,UP1,UP2,UP3,...
%     VN,VC,VP1,VP2,VP3,...
%     PC,PP1,PP2,PP3,PP4,...
%     Tem1,...
%     dvdx2,dpdy,dudy2,dpdx,dvdt,dudt,tem,dvdx,dudy,ad41,ad42,timeint,BC,bcp,...
%     rhsuP1,rhsuP2,rhsuP3,rhsvP1,rhsvP2,rhsvP3,...
%     count,ad21,ad22,dte,dt,dtn,WENO,uw,cons)
%% read in fS
dt  = fS.dt;
dte = fS.dte;
dtn = fS.dtn;
